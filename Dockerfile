...
RUN apk --update add curl tar \
  && mkdir /ttnsrc \
  && curl -sL -o /ttnsrc/ttn-linux-amd64.tar.gz "https://ttnreleases.blob.core.windows.net/release/src/github.com/edwindvinas/ttn/release/branch/master/ttn-linux-amd64.tar.gz" \
